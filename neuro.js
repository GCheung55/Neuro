...
(function (modules, global) {
    ...
    '0': function (require, module, exports, global) {
        ...
        Neuro.Collection = require('3').Collection;
        Neuro.View = require('4').View;
        Neuro.Router = require('5').Router;
        Neuro.Route = require('6').Route;
        Neuro.Is = require('7').Is;
        Neuro.Mixins = {
            Butler: require('8').Butler,
            Connector: require('9').Connector,
            Silence: require('a').Silence,
            Snitch: require('b').Snitch
        };
        exports = module.exports = Neuro;
    },
    '1': function (require, module, exports, global) {
        exports = module.exports = { version: '0.2.8' };
    },
    '2': function (require, module, exports, global) {
        var Model = require('c').Model, Butler = require('8').Butler, Snitch = require('b').Snitch, signalFactory = require('d');
        ...
        Model.implement(signalFactory(['error'], {
            signalErrorProperty: function (prop, val) {
                !this.isSilent() && this.fireEvent('error:' + prop, [
                    this,
                    prop,
                    val
                ]);
    ...
    '3': function (require, module, exports, global) {
        var Collection = require('e').Collection, Model = require('2').Model, Snitch = require('b').Snitch;
        ...
        exports.Collection = new Class({
            ...
            signalError: function (model, at) {
                !this.isSilent() && this.fireEvent('error', [
                    this,
                    model,
                    at
                ]);
    ...
    '5': function (require, module, exports, global) {
        var collectionObj = require('3'), routeObj = require('6'), signalFactory = require('d');
                    ...
                    if (request !== this._prevMatchedRequest && request !== this._prevBypassedRequest) {
                        ...
                        if (n) {
                            ...
                            while (i < n) {
                                ...
                                cur.isFirst = !i;
                                this.signalMatch.apply(this, defaultArgs.concat([
                                    request,
                                    cur
                                ]));
                                i += 1;
        ...
        Router.implement(signalFactory([
            'match',
            'default'
        ]));
    ...
    '6': function (require, module, exports, global) {
        var Route = require('g').Route, PatternLexer = require('h');
    ...
    '7': function (require, module, exports, global) {
        (function (context, global) {
            ...
            var eq = function (a, b, aStack, bStack) {
                ...
                if (a == null || b == null)
                    return a === b;
                if (a.isEqual && Is.Function(a.isEqual))
                    return a.isEqual(b);
                if (b.isEqual && Is.Function(b.isEqual))
                    return b.isEqual(a);
                ...
                if (typeA == 'array') {
                    ...
                    if (aConstructor !== bConstructor && !(Is.Function(aConstructor) && instanceOf(aConstructor, aConstructor) && Is.Function(bConstructor) && instanceOf(bConstructor, bConstructor)))
                        return false;
                    for (var key in a) {
                        if (has(a, key)) {
                            size++;
    ...
    'c': function (require, module, exports, global) {
        var Is = require('7').Is, Silence = require('a').Silence, Connector = require('9').Connector, signalFactory = require('d');
        ...
        Model.implement(signalFactory([
            'change',
            'destroy',
            'reset'
        ], {
            signalChangeProperty: function (prop, newVal, oldVal) {
                !this.isSilent() && this.fireEvent('change:' + prop, [
                    this,
                    prop,
                    newVal,
                    oldVal
    ...
    'e': function (require, module, exports, global) {
        var Model = require('2').Model, Silence = require('a').Silence, Connector = require('9').Connector, signalFactory = require('d');
        ...
        Collection.implement(signalFactory([
            'empty',
            'sort',
            'change',
            'add',
    ...
    'f': function (require, module, exports, global) {
        var Connector = require('9').Connector, Silence = require('a').Silence, signalFactory = require('d');
    ...
    'g': function (require, module, exports, global) {
        var modelObj = require('2'), signalFactory = require('d'), typecastValue = require('j'), decodeQueryString = require('k');
